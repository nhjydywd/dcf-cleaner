...
/// A draggable divider that reports a 1D "position" based on pointer movement.
///
/// This uses the "drag start global position + initial position" model (instead
/// of incremental deltas) so clamping in the consumer feels natural.
